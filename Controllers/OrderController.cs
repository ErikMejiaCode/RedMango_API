...
namespace RedMango_API.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        //Getting orders based on userId
        [HttpGet("{id:int}")]
        ...
        public async Task<ActionResult<ApiResponse>> UpdateOrderHeader(int id, [FromBody] OrderHeaderUpdateDTO orderHeaderUpdateDTO)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(orderHeaderUpdateDTO.StripedPaymentIntentId))
                {
                    orderFromDb.StripedPaymentIntentId = orderHeaderUpdateDTO.StripedPaymentIntentId;
                }
