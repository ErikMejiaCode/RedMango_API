...
namespace RedMango_API.Controllers
{
    ...
    public class ShoppingCartController : ControllerBase
    {
        ...
        //Retieve shopping cart based on user id
        [HttpGet]
        ...
        public async Task<ActionResult<ApiResponse>> AddOrUpdateItemInCart(string userId, int menuItemId, int updateQuantityBy)
        {
            ...
            // Cart items will hav all the items in shopping cart for a user.
            // Updatequantityby will have count by with an items quantity needs to be updated.
            // if it is -1 that means we have to lower a count if it is 5 it means we have to add 5 count to existing count.
            ...
            // when a user removed an existing item 

            // when a user adds a new item to a new shopping cart for the first time 
            //Retrieving a shopping cart based on the userid if it exists
            ...
            MenuItem menuItem = _db.MenuItems.FirstOrDefault(u => u.Id == menuItemId);
             ...
             else 
             {
                ...
                {
                    //item already exists in the cart and we have to update the quantity
